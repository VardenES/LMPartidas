...
<!-- ////////// NUEVOS CAMPOS FORMULARIO \\\\\\\\\\ -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <input name="birthday" value="date.struct" type="hidden">
                                <select name="birthday_day" id="birthday_day" class="form-control-birthday">
                                ...
                                <select name="birthday_month" id="birthday_month" class="form-control-birthday">
                                    <option value="" selected="selected"></option>
                                ...
                                <select name="birthday_year" id="birthday_year" class="form-control-birthday">
                                    <option value="" selected="selected"></option>
 ...
 <!-- Provincia -->
                        ...
                        <div class="form-group{{ $errors->has('club') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="club" type="text" class="form-control" name="club" value="{{ old('club') }}" required autofocus>
